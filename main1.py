...
SCREEN_WIDTH = 640               #width of the window
...
class Ball:
    def __init__(self, position_x, position_y, radius, color):
        ...
        self.position_x = position_x            #variables of the ball
...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        # Create our ball
        self.ball = Ball(50, 50, 15, arcade.color.AUBURN)  #creates the ball
    ...
    def on_mouse_motion(self, x, y, dx, dy):
        ...
        self.ball.position_x = x                     #affects the movement of the ball
        self.ball.position_y = y                     #affects the movement of the ball

    def on_mouse_press(self, x, y, button, modifiers):
        """
        Called when the user presses a mouse button.
        """
        print(f"You clicked button number: {button}")  #tells you the button number of the button you pushed
